		...
		if (account != "")
		{
			...
			xhttp.onreadystatechange = function() {
				...
				if (this.readyState == 4 && this.status == 200) {
					...
					document.getElementById("checkExist").innerHTML = message;
				}
			};
			xhttp.open("POST", "check_account.php", true);
			xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
			xhttp.send("uname="+account);
		}
		else
		{
				...
				<div class="col-md-4 col-md-offset-4">
					...
					<form action="register.php" method="post" class="fh5co-form animate-box" data-animate-effect="fadeIn">
						...
						<div class="form-group">
							...
							<input type="text" name="phonenumber" class="form-control" id="phonenumber" placeholder="PhoneNumber" autocomplete="off">
						</div>
						<div class="form-group">
							...
							<label for="Account" id="checkExist"></label>
						</div>
						<div class="form-group">
